...
Libraries used: - Pandas - for data manipulation and analysis - Matplotlib.pyplot - for creating visualisations, and pyplot provides a simplified interface for creating charts and plots - Numpy - for numerical computing
